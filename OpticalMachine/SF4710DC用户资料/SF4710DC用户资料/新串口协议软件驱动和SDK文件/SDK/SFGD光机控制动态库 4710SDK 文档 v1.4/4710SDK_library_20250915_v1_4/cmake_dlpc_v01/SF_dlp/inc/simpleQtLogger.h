...
#ifndef SIMPLE_QT_LOGGER_H
#define SIMPLE_QT_LOGGER_H
...
#ifdef Q_OS_LINUX
#  define ENABLE_SQTL_LOG_SINK_SYSLOG    0   // 1: enable, 0: disable; log to the system logger
#else
...
#  define ENABLE_SQTL_LOG_LEVEL_FATAL      0   // 1: enable, 0: disable
#endif
...
#  define ENABLE_SQTL_LOG_LEVEL_NOTE       0   // 1: enable, 0: disable
#endif
...
DLPHANDLE_LIBRARY_EXPORT extern bool ENABLE_LOG_SINK_FILE;    // Log-sink: true: enable, false: disable, default: true
DLPHANDLE_LIBRARY_EXPORT extern bool ENABLE_LOG_SINK_CONSOLE; // Log-sink: true: enable, false: disable, default: false
DLPHANDLE_LIBRARY_EXPORT extern bool ENABLE_LOG_SINK_QDEBUG;  // Log-sink: true: enable, false: disable, default: false
DLPHANDLE_LIBRARY_EXPORT extern bool ENABLE_LOG_SINK_SIGNAL;  // Log-sink: true: enable, false: disable, default: false
DLPHANDLE_LIBRARY_EXPORT extern bool ENABLE_LOG_SINK_SYSLOG;  // Log-sink: true: enable, false: disable, default: false
...
struct DLPHANDLE_LIBRARY_EXPORT EnableLogLevels {
...
DLPHANDLE_LIBRARY_EXPORT extern EnableLogLevels ENABLE_LOG_LEVELS;

// Log-function stack-trace
DLPHANDLE_LIBRARY_EXPORT extern bool ENABLE_FUNCTION_STACK_TRACE; // Log-function stack-trace: true: enable, false: disable, default: true

// Sink console color
DLPHANDLE_LIBRARY_EXPORT extern bool ENABLE_CONSOLE_COLOR; // Color for sink console: true: enable, false: disable, default: true
// Sink console trimmed messages
DLPHANDLE_LIBRARY_EXPORT extern bool ENABLE_CONSOLE_TRIMMED; // Whitespaces trimmed for sink console: true: enable, false: disable, default: true

// Console
DLPHANDLE_LIBRARY_EXPORT extern bool ENABLE_CONSOLE_LOG_FILE_STATE; // Console output log-file state: true: enable, false: disable, default: true
...
class DLPHANDLE_LIBRARY_EXPORT SimpleQtLogger : public QObject
{
    Q_OBJECT
